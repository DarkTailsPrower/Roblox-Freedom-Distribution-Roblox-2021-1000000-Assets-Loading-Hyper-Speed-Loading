...
function configureAnimationSet(name, fileList)print(666)
			...
			if childPart:IsA("Animation") then
				...
				if name == "run" or name == "walk" then
					if lv then
						...
						warn(
							"Strafe blending disabled. No linear velocity information for "
								.. '"'
								.. "walk"
								.. '"'
								.. " and "
...
function scriptChildModified(child)return
