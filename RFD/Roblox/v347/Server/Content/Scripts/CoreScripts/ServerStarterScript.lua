...
--[[ Add Freedom Distribution CoreScript ]]--
ScriptContext:AddCoreScriptLocal("RFDStarterScript", script.Parent)
...
print('RemoteFunction_GetServerVersion',RemoteFunction_GetServerVersion)
